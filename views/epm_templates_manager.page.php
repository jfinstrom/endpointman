<?php
	...
	echo load_view(__DIR__.'/epm_templates/manager.views.grid.php', ['request' => $_REQUEST]);
	echo load_view(__DIR__.'/epm_templates/manager.views.new.modal.php', ['request' => $_REQUEST]);
